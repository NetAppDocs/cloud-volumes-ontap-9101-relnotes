---
sidebar: sidebar
permalink: concept_licensing_9101.html
...
= Licensing for Cloud Volumes ONTAP 9.10.1
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
* https://docs.netapp.com/us-en/occm/task_deploying_otc_aws.html[Launching Cloud Volumes ONTAP in AWS^]
* https://docs.netapp.com/us-en/occm/task_deploying_otc_azure.html[Launching Cloud Volumes ONTAP in Azure^]
* https://docs.netapp.com/us-en/occm/task_deploying_gcp.html[Launching Cloud Volumes ONTAP in Google Cloud^]
...
. https://docs.netapp.com/us-en/occm/task_managing_licenses.html[Add your license to Cloud Manager^].
...
. After NetApp authorizes your account, https://docs.netapp.com/us-en/occm/task_managing_licenses.html#link-a-subscription[link your subscriptions for use with Cloud Volumes ONTAP].
...
https://docs.netapp.com/us-en/occm/concept_cloud_central_accounts.html[Learn more about NetApp accounts^].
