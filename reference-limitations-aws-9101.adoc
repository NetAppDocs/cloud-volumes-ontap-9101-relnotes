---
sidebar: sidebar
permalink: reference-limitations-aws-9101.html
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference-limitations-9101.html[Limitations for Cloud Volumes ONTAP 9.10.1 in all cloud providers].
