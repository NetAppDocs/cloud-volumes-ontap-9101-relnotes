---
sidebar: sidebar
permalink: reference-limits-gcp-9101.html
...
= Storage limits for Cloud Volumes ONTAP 9.10.1 in GCP
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
For some configurations, disk limits prevent you from reaching the capacity limit by using disks alone. You can reach the capacity limit by https://docs.netapp.com/us-en/occm/concept_data_tiering.html[tiering inactive data to object storage^]. Refer to the disk limits below for more details.
