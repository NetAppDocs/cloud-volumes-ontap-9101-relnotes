...
* c4, m4, and r4 instance types are not supported with new Cloud Volumes ONTAP systems in this release. However, we're still showing disk limits for these instance types because you can upgrade a system to this release when running on one of these instance types.
