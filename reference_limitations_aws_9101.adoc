---
sidebar: sidebar
permalink: reference_limitations_aws_9101.html
...
= Known limitations for Cloud Volumes ONTAP 9.10.1 in AWS
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Amazon Web Services. Be sure to also review link:reference_limitations_9101.html[Limitations for Cloud Volumes ONTAP 9.10.1 in all cloud providers].
