---
sidebar: sidebar
permalink: reference_limitations_azure_9101.html
...
[.lead]
The following known limitations are specific to Cloud Volumes ONTAP in Microsoft Azure. Be sure to also review link:reference_limitations_9101.html[Limitations for Cloud Volumes ONTAP 9.10.1 in all cloud providers].
